...
//	m_row = r;
//	m_col = c;
//	m_lives = 2;	// Each zombie starts with two lives
//}
//
...
//{
//	// If the zombie attacked has one life, or is pushed off the edge, it dies.
//	// Otherwise, it is hit back one position and loses a life.
//	if ((m_lives == 1) || (dir == UP && m_row == 1) || (dir == DOWN && m_row == m_arena->rows())
//		|| (dir == LEFT && m_col == 1) || (dir == RIGHT && m_col == m_arena->cols()))
//		return true;
//	m_arena->determineNewPosition(m_row, m_col, dir);
//	m_lives--;
//	return false;
...
//void Player::stand()
//{
//	// If the player doesn't move, its age increases by one
//	m_age++;
//}
//
...
//{
//	m_age++;
//	// Attack a zombie if they are adjacent to player in direction dir,
//	// Otherwise just move in direction dir
//	switch (dir) {
//	case UP:
...
//Arena::~Arena()
//{
//	// Deletes the player object and all the zombie objects
//	delete m_player;
...
//{
//	// Returns the amount of zombies at (r, c)
//	int count = 0;
...
//{
//	// Moves arena object in direction if possible, and returns false if not (on edge)
//	switch (dir)
//	{
//	case UP:
//		if (r == 1)
...
//	for (int i = 0; i < zombieCount(); i++) {
//		int r = m_zombies[i]->row();
//		int c = m_zombies[i]->col();
...
//			gridChar = '2';
//		} 
//		else if (gridChar > '1' && gridChar < '8') {
//			gridChar = numZombiesAt(r, c) + '0';
//		} 
//		else if (gridChar >= '8') {
//			gridChar = '9';
//		} 
...
//{
//	// Dynamically allocates a zombie at (r, c) if there aren't MAXZOMBIES
//	if (zombieCount() == MAXZOMBIES)
//		return false;
//
//	m_zombies[zombieCount()] = new Zombie(this, r, c);
//	m_nZombies++;
//	
//	return true;  
//
...
//{
//	// Attacks zombie at (r, c) if there's one there and destroys it if it has one life. 
//	int loc = 0;
//	for (int i = 0; i < zombieCount(); i++) {
//		if (m_zombies[i]->row() == r && m_zombies[i]->col() == c) {
//			loc = i;
...
//		if (m_zombies[loc]->getAttacked(dir)) {
//			delete m_zombies[loc];
//			for (int k = loc; k < zombieCount()-1; k++)
...
//{
//	// Loops through the zombie array and moves each one in a random direction.
//	for (int k = 0; k < m_nZombies; k++)
//	{
//		m_zombies[k]->move();
//		// If a zombie lands on the player, the player dies.
...
//{
//	// Create a game
//	// Use this instead to create a mini-game:  Game g(3, 4, 25);
//	Game g(7, 8, 25);
//
//	// Play the game
//	g.play();
...
///////////////asdfjhafdiuqrefoyqfasdsadf asdfjahfd// zombies.cpp
